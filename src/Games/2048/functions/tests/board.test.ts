...
describe('board', () => {
  ...
  it('initializes board with two non-zero tiles', () => {
    ...
    expect(update.board.filter((value: number) => value === 0).length).toBe(
      boardSize ** 2 - 2
    );
  });
  ...
  it('moves tiles down', () => {
    ...
    expect(update.board.filter((value: number) => value !== 0).length).toBe(2);
  });
  ...
  it('merges tiles in a non-greedy fashion: variant #1', () => {
    ...
    expect(update.scoreIncrease).toBe(8);
    expect(update.board.filter((value: number) => value !== 0).length).toBe(3);
  });
  ...
  it('merges tiles in a non-greedy fashion: variant #3', () => {
    ...
    expect(update.board.filter((value: number) => value !== 0).length).toBe(5);
  });
});
