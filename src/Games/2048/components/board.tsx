...
const Board: React.FC = () => {
  ...
  const startPointerLocation = useRef<Point | null>(null);
const currentPointerLocation = useRef<Point | null>(null);
  ...
  const onTouchEnd = useCallback(
    (e: React.TouchEvent) => {
      ...
      startPointerLocation.current = null;
      currentPointerLocation.current = null;
    },
    [finishPointer]
  );
